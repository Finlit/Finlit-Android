package com.app.finlit.utils.image;
...
public class ImageLoaderUtils {
    ...
    public static final DisplayImageOptions UIL_DEFAULT_DISPLAY_OPTIONS = new DisplayImageOptions.Builder()
            ...
            .cacheOnDisc(true).showImageOnFail(R.mipmap.default_user).cacheInMemory(true).build();

    public static final DisplayImageOptions UIL_ICON_DISPLAY_OPTIONS = new DisplayImageOptions.Builder()
            .showImageOnLoading(0).showImageForEmptyUri(0)
            .showImageOnFail(0).cacheOnDisc(true).cacheInMemory(true).build();
    ...
    public static class SmartUriDecoder implements ImageDecoder {
        ...
        private void addVideoIcon(Bitmap source) {
            ...
            Bitmap icon = BitmapFactory.decodeResource(context.get().getResources(), R.mipmap.ic_launcher);
