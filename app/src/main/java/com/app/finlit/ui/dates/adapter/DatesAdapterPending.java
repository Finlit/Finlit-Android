...
public class DatesAdapterPending extends RecyclerView.Adapter<DatesAdapterPending.ViewHolder> {
    ...
    public DatesAdapterPending(Context context, List<DateStatusModel> items, OnActionListener<DateStatusModel> onActionListener,
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        switch (type) {
            case ITEM:
                view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_dates_pending, parent, false);
                break;
            case LOADING:
...
//        holder.tv_time.setText(new SimpleDateFormat("dd-MM-yyyy HH:mm").format(model.getDate()));
    ...
    private void displayImageIcon(String attachUrl, final DatesAdapterPending.ViewHolder viewHolder) {
        ImageLoader.getInstance().displayImage(attachUrl, viewHolder.iv_Profile,
                ImageLoaderUtils.UIL_DEFAULT_DISPLAY_OPTIONS);
    }

    private void displayImageIcons(String attachUrl, final DatesAdapterPending.ViewHolder viewHolder) {
