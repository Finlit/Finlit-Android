...
public class SingleDateAndTimePicker extends LinearLayout {
    ...
    public SingleDateAndTimePicker(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        inflate(context, com.github.florent37.singledateandtimepicker.R.layout.single_day_picker, this);

        yearsPicker = findViewById(com.github.florent37.singledateandtimepicker.R.id.yearPicker);
        monthPicker = findViewById(com.github.florent37.singledateandtimepicker.R.id.monthPicker);
        daysOfMonthPicker = findViewById(com.github.florent37.singledateandtimepicker.R.id.daysOfMonthPicker);
        daysPicker = findViewById(com.github.florent37.singledateandtimepicker.R.id.daysPicker);
        minutesPicker = findViewById(com.github.florent37.singledateandtimepicker.R.id.minutesPicker);
        hoursPicker = findViewById(com.github.florent37.singledateandtimepicker.R.id.hoursPicker);
        amPmPicker = findViewById(com.github.florent37.singledateandtimepicker.R.id.amPmPicker);
        dtSelector = findViewById(com.github.florent37.singledateandtimepicker.R.id.dtSelector);
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        setTodayText(a.getString(com.github.florent37.singledateandtimepicker.R.styleable.SingleDateAndTimePicker_picker_todayText));
        ...
        setMustBeOnFuture(a.getBoolean(com.github.florent37.singledateandtimepicker.R.styleable.SingleDateAndTimePicker_picker_mustBeOnFuture, MUST_BE_ON_FUTUR_DEFAULT));
